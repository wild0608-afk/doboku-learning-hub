...
function renderGuide() {
  const items = [
    ...
    },
    {
      icon: '📚',
      title: '分野・章ごとに学ぶ',
      body: '分野別学習では、各分野（権利関係・宅建業法・法令上の制限・税その他）を選んだ後、さらに「第1章」「第2章」「第3章」（各25問）に分けて学習できます。特定の章を集中的に学ぶことで苦手な単元を効率よく攻略できます。「全章」を選ぶとその分野の全75問をまとめて出題します。',
    },
    {
      icon: '🧪',
      title: 'β版について',
      body: '本アプリは現在β版です。問題・解説の内容は随時改善・追加されます。現在300問収録（権利関係・宅建業法・法令上の制限・税その他 各75問）。今後500問への拡充を予定しています。お気づきの点があればフィードバックをお寄せください。',
    },
  ];
